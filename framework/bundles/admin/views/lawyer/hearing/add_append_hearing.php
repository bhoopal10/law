...
<div class="row-fluid">
    <form name="form2" class="form-horizontal" action="<?php echo URL::to_route('AddHearing'); ?>" method="post" onsubmit="return dateValidation();">
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" name="docket_no" value="<?php if(isset($case->docket_no)) echo $case->docket_no;?>" readonly>
                </div>
        </div>
        <div class="control-group">
            <label class="control-label" for="crime_no">Crime No:</label>
            <div class="controls">
                <input type="text" disabled value="<?php if(isset($case->crime_no)) echo $case->crime_no;?>">
            </div>
        </div>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class="datepicker" id="dup_from"  value="<?php echo date('d/m/Y',strtotime($hearing->next_hearing_date));  ?>" READONLY/>
        ...
        <div class="control-group">
            ...
            <div class="controls">
                <input type="text" class="datepicker" id="dup_to"  />
    ...
    <div class="span12 modal-body">
        <form id="uploadDoc" name="form1" class="form-horizontal" action="<?php echo URL::to_route('AddHearingDocuments'); ?>" method="post" enctype="multipart/form-data">
            ...
            <div class="control-group">
                <label class="control-label" for="crime_no">Crime No:</label>
                <div class="controls">
                    <input type="text" name='crime_no' value="<?php if(isset($case->crime_no)){ echo $case->crime_no;}?>" readonly>
                </div>
            </div>
