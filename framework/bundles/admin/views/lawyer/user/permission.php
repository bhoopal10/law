...
<?php }?>
 <div class="row-fluid">
     ...
     $case1=libcase::getAssociateCasePermissionByAssID($id);
     ...
     <div class="span6">
         <form name="form2" action="<?php echo URL::to_route('UserCasePermissionSearch'); ?>" method="get">
             ...
             <select name="case_id" id="case_id" style="width: 220px" onchange='this.form.submit()'>
                 ...
                 <?php if(isset($_GET['case_id'])){$case_id_id=$_GET['case_id'];if($case_id){ ?>
    ...
    <div class="span5">
            ...
            <table class="table table-bordered table-straped">
                ...
                <tbody>
                <?php if(isset($cases) && isset($ass_id)){ foreach($ass_id->results as $case){  ?>
                    <tr>
                        <td> <label><input name="case_id[]" type="checkbox" value="<?php echo $case->case_id; ?>"><span class="lbl"></span></label></td>
                    <td><?php echo ucfirst($case->case_no); ?></td>
                        <?php $permission = get_value_with_2compare_from_multi_object_array($id, $case->case_id,$case1,'uid','case_id','permission'); ?>
