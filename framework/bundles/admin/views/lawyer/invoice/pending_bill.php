 ...
 */  ?>
 ...
 <?php } elseif(isset($error)){ ?>
     ...
     <form name="search" action="<?php echo URL::to_route('PendingBill'); ?>" method="get" onsubmit=" return searchValidation();">
         <select class="select2" name="client_id" style="width:200px" onchange="this.form.submit();">
         ...
         <input type="text" name="from_date" id='from' placeholder="From date" <?php echo (Input::old('from_date')?'value="'.Input::old('from_date').'"':''); ?> onchange="this.form.submit();">
          To
          <input type="text" name="to_date" id="to" placeholder="to Date" <?php echo (Input::old('to_date')?'value="'.Input::old('to_date').'"':''); ?> onchange="this.form.submit()">
     </form>
     <table class="table table-bordered table-striped">
         ...
         <tr >
             ...
             <td style="cursor: pointer"  onclick="window.document.location='<?php echo URL::to_route('HistoryInvoice').'?l='.$invoices->from_user.'&c='.$invoices->to_user; ?>';"><?php echo date('d/m/Y', strtotime($invoices->created_date)); ?></td>
                 ...
                 <div class="btn-group">
                     ...
                     <ul class="dropdown-menu">
                         <li>
                           ...
                           data-to_user="<?php echo $invoices->to_user; ?>">Pay</a>
                         </li>
                     </ul>
                 </div>
             </td>
