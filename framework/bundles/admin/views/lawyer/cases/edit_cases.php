                                ...
                                if (isset($court_setting)) {
                                    ...
                                    if(isset($json)){
                                        foreach($json as $value){ ?>
                                            <option value="<?php echo $value; ?>" ><?php echo $value; ?></option>
                                        <?php }}} ?>
                            </select><span><a title="Add new opp-associate" data-toggle="modal" href="#new_opp_advocate">Add New</a></span>
                        </div>
                    </div>
                    <!-- End Opp Advocate -->
                    <!-- Start Court name -->
...
<div id="new_client1" class="modal hide fade" style="display: none; ">
    ...
    <div class="modal-body">
        <form class="form-horizontal" action="#" method="post" id="AddClientForm" onsubmit="return uploadClient();">
            <div class="control-group">
...
//                    var case_subject=document.form1.case_subject.value;
                    ...
                    var all={case_no:case_no,client_Name:client_name}
                    for(var val in all)
                    {
                        if(!all[val])
                        {
                ...
                on('finished' , function(e, info){
                    ...
                    $.post("<?php echo URL::to_route('UpdateCases'); ?>",all)
                        .success(function(data){
                            if(!data)
                            {
                                alert('Your not change anything');
                            }
                            if(data)
                            {
                                alert('Your case has been Updated successfully');
                            }
