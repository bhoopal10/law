    ...
    <tr style="background:#9bcaff">
        <td style="padding-left:20px">
            <a target="_blank" style="text-decoration:none;color:inherit;font-family:'HelveticaNeue','Helvetica Neue',Helvetica,Arial,sans-serif;font-weight:normal;">
                <h1 style="color:#fff">Lawyerzz - NewPassword</h1>
            </a>
        </td>
    </tr>
    </tbody>
<tr>
    <td>
        ...
        <span style="float: left;font-weight: bold">UserName:&nbsp;&nbsp;</span>
        <span style="text-align: center;font-weight: bold"><?php echo $username; ?></span>
        <br>
        <span style="float: left;font-weight: bold">Password:&nbsp;&nbsp;</span>
        <span style="text-align: center;font-weight: bold"><?php echo $password; ?></span>
        <br>
