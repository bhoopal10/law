...
www.bigrock.in   
username :reddiss1@gmail.com   
pw :sirinivasam1234
208.91.198.24/cpanel
...
<div id="page-content" class="clearfix">
    ...
    <div class="control-group">
        ...
        <div class="controls">
            <input type="text" class="date-picker1"  style="width: 99px">
            <input type="hidden" name="from_date[]" id="from_date" class="date-picker" data-date-format="yyyy-mm-dd" style="width: 99px">
    ...
    <div class="control-group">
        ...
        <div class="controls">
           <input type="text" class="date-picker1" style="width: 99px">
           <input type="hidden" name="to_date[]" id="to_date" class="date-picker" style="width: 99px">
