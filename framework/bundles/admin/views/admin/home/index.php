                    ...
                    <div class="widget-main">
                        ...
                        <div class="clearfix">
                            <div class="grid3">
                                ...
                                <h4 class="bigger pull-right"><?php echo libclient::countclient();  ?></h4>
                            </div>

                            <div class="grid3">
													<span class="grey">
														<i class="icon-legal icon-2x purple"></i>
														&nbsp;<a href="<?php echo URL::to_route('ViewUser') ?>"><b>Lawyers</b></a>
													</span>
...
<script type="text/javascript">
    $(function() {
        ...
        var data = [
            { label: "Pending Case",  data: <?php if(isset($pending_case)) echo $pending_case;  ?>, color: "#DA5430"},
            { label: "Processing Case",  data: <?php if(isset($processing_case)) echo $processing_case;  ?>, color: "#2091CF"},
            { label: "Completed Cases",  data: <?php if(isset($completed_case)) echo $completed_case;  ?>, color: "#68BC31"}
