    ...
    <div class="step-content row-fluid position-relative">
        <div class="step-pane active" id="step1">
            ...
            <form name="form1" action="<?php echo URL::to_route('AddCases'); ?>"  method="post" class="form-horizontal" id="case-form">
                ...
                <input type="hidden" name="associate_id" value="<?php echo $id;  ?>"/>
                <!-- Start Docket_No -->
...
<div class="modal-body">
    <form class="form-horizontal" onsubmit="return addClient();" method="post" id="AddClientForm" >
        <div class="control-group">
        ...
        <div class="control-group">
            <div class="controls">
                <button class="btn btn-primary" id="AddClient" type="submit">Add</button>
