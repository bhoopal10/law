...
<?php }?>
<?php $case=libcase::getcasedetail();$user_id=Auth::user()->id; ?>
    <div class="row-fluid">
        <div class="span12">
            <form name="form1" class="form-horizontal" action="<?php echo URL::to_route('AddCaseDocument');  ?>" method="post" enctype="multipart/form-data" onsubmit="return validation();">
                ...
                <input type="hidden" name="associate_id" value="<?php  echo Crypter::encrypt($user_id);?>"/>
