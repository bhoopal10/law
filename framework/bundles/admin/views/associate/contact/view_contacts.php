            ...
            <tr class="odd">
                ...
                <td class="td-actions ">
                    <div class="hidden-phone visible-desktop btn-group">
                       <a title="Edit" class="btn btn-mini btn-info" href="<?php echo URL::to_route('EditContact').'/'.Crypter::encrypt($key);  ?>">
                            <i class="icon-edit bigger-120"></i>
                        </a>
                        <a title="Delete" class="btn btn-mini btn-danger" onclick="return confirm('Are you want to delete!')" href="<?php echo URL::to_route('DeleteContact').'/'.Crypter::encrypt($key); ?>">
