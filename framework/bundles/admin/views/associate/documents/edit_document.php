...
<?php if(isset($document)){ Session::put('document',$document); ?>
    ...
    <div class="row-fluid">
        <div class="span12">
            <form name="form1" onsubmit="return validation();" class="form-horizontal" action="<?php echo URL::to_route('UpdateDocument');  ?>" method="post" enctype="multipart/form-data">
                ...
                <div class="control-group">
                    <div class="controls">
                        ...
                        <a class="btn btn-danger" href="<?php echo URL::to_route('ViewDocuments'); ?>">Back</a>
                    </div>
                </div>
...
<?php }  ?>
    <script type="text/javascript">
      function validation()
      {
          ...
          var case_link=document.form.case_link.value;
          var doc=document.form.doc_file.value;
          if(!case_link)
          {
